...
def plotSignalEnergyFreqBands(path,fstep,tclip=None,fmin=0.1):
    ...
    for c in ['Input 0','Input 1']:
        ...
        for fA,fB in zip(fsteps,fsteps[1:]):
            yf = butter_bandpass_filter(signal,fA,fB, order = 5  )
    ...
    for fn in glob(path):
        ...
        if periods:
            ...
            for sname,chunk in periods.items():
                ...
                time,i0,i1 = loadTDMSSub(path,chunk,is_time=True)
                # plot period
                f, Pxx_i0 = signal.welch(i0, 1e6,nperseg=8192) #1024
                if kwargs.get("freq_clip",None):
                    f0,f1 = kwargs.get("freq_clip",None)
                ...
                f, Pxx_i1 = signal.welch(i1, 1e6,nperseg=8192)
                if kwargs.get("freq_clip",None):
                    f0,f1 = kwargs.get("freq_clip",None)
...
if __name__ == "__main__":
  ...
  #  replotAE("ae/sheff_lsbu_stripe_coating_2.tdms",clip=False)#,ds=10)
    plotSTFTStripes("ae/sheff_lsbu_stripe_coating_2.tdms", nperseg=256,fclip=None,use_log=True)
    #plotLombScargle("ae/sheff_lsbu_stripe_coating_2.tdms",freqs=np.arange(300e3,350e3,1e3),normalize=True)
...
#    filterStripes("ae/sheff_lsbu_stripe_coating_2.tdms",270e3,'highpass')
 #   filterStripes("ae/sheff_lsbu_stripe_coating_3_pulsing.tdms",300e3,'highpass')
    #plotSignalEnergyFreqBands("ae/sheff_lsbu_stripe_coating_2.tdms",fstep=10,tclip=None,fmin=0.1)
...
##    periodogramStripes("ae/sheff_lsbu_stripe_coating_2.tdms")
    #welchStripesOverlap("ae/sheff_lsbu_stripe_coating_2.tdms",freq_clip=[8e3,17e3],use_fr=True)
  ...
  ##  drawEdgeAroundStripe("ae/sheff_lsbu_stripe_coating_2.tdms",dist=int(50e3),mode="separate", stripe_ref = "stripe_1_4")
   ...
   # plotStripesLimits("ae/sheff_lsbu_stripe_coating_1.tdms")
    ...
    #welchStripesOverlap("ae/sheff_lsbu_stripe_coating_3_pulsing.tdms",freq_clip=[100e3,350e3],use_fr=False)
...
#    welchStripes("ae/sheff_lsbu_stripe_coating_2.tdms", freq_clip = [100e3,350e3])
